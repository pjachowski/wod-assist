...
| Cold start on large global scope exceeds 3s NFR                | Pre-mortem       | Low        | Medium | Keep Worker bundle lean. Defer heavy imports behind dynamic `import()`. Monitor with `wrangler tail` latency.                         |
